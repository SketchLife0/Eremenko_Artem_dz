class Car:
    ...
    def turn(self, direction: str) -> None:
        ...
        if direction.lower() in direction_list:
            print(f'{self.name}: движется {direction.lower()}')
        else:
...
if __name__ == '__main__':
    ...
    # Либо не все поставленные задачи описаны, либо в подсказке ошибка, так как метод не должен вызывать '(SportCar)'
